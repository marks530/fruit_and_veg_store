...
This page displays a single product with its image and product information including a description. For the superuser the ![button]Edit|Delete option is also available. Products can be purchased by weight or quantity and the corresponding buttons will be displayed.
