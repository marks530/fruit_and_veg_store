...
- Page Link Summary:
    ...
    •	Login – Upon clicking this button, the user is directed the login form where they can enter their details (if they have already signed up) to access their account.
